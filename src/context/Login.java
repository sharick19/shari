...
public class Login extends BaseWindow {
    ...
    private ButtonComponent button_two;
    ...
    public Login(Translations lang, String title) {
        ...
        createCombo();
        createButton();
        createAnotherButton(); // Crear el nuevo botón
    }
    ...
    private void createAnotherButton() { 
        this.button_two = new ButtonComponent(this.lang.getI18nText(TextCodes.ButtonTextPro), this.rightPanel);
        this.button_two.setPosition(260);
        this.rightPanel.add(this.button_two);
        this.button_two.addActionListener(y -> {
            
             this.getListener().onEvent("click-pro", y); 
        });
    }
